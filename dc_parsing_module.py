...
PROMPT = """Extract Delivery Challan (DC) details and return ONLY valid JSON with fields:
- dc_number, dc_date, po_number, supplier_name, vehicle_number,
- line_items: array of {item_code, description, quantity, uom, remarks},
...
class DCFieldGenerator:
    def __init__(self):
        if not LLM_CONFIG.get("api_key"):
            raise ValueError("GROQ_API_KEY not set in environment.")
        self.agent = ConversableAgent(
            name="dc_field_generator",
            system_message="You extract structured Delivery Challan data. Return valid JSON only.",
